...
public class InicioCena implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        desenhaTitulo(gl, 0, 710, Color.BLACK, "PONG GAME");
        desenhaTexto(gl, "REGRAS:\nNeste jogo você tem uma requete que pode ser controlada pelas SETAS do teclado" +
                "\nO objetivo é destruir todos os blocos sem deixar que a bola caia \n\n" +
                "\n\n Pressione ESPAÇO para iniciar, \n ESC para sair do modo tela cheia \n e P para pausar o jogo");
